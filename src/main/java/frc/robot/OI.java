...
public class OI {
  ...
  public JoystickButton extendHatchButton = new JoystickButton(driverController, 1);
  public JoystickButton retractHatchButton = new JoystickButton(driverController, 2);
